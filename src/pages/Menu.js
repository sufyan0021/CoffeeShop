...
import MenuListVariant from '../components/MenuListVariant';
    ...
    <React.Fragment>
      ...
      <section className="main-content menu">
        ...
        <p className="menu-info">
          <span className="bold">Milk Selections:</span> Low Fat, Skim, Half &
          Half, Almond, Oat
        </p>
        <p className="menu-info">
          <span className="bold">House Made Syrups $0.50:</span> Mocha, White
          Mocha, Caramel, Vanilla, Cinnamon, Raspberry, Hazelnut, Lavender
        </p>
        <h4>Coffee</h4>
